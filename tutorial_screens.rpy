...
translate italian tutorial_screens_2faa22e5:
    ...
    e "Gli schermi sono la parte più potente di Ren'Py. Gli schermi ti permettono di personalizzare l'interfaccia fuori dal gioco e creare nuovi componenti dell'interfaccia di gioco."
...
translate italian screens_menu_7f31d730:
    ...
    e "Cosa vorresti sapere sugli schermi?" nointeract
...
translate italian screens_demo_115a4b8f:
    ...
    e "Gli schermi sono il modo in cui creiamo l'interfaccia utente in Ren'Py. Ad eccezione delle immagini e delle transizioni, tutto ciò che vedi proviene da uno schermo."
...
translate italian screens_demo_ce100e07:
    ...
    e "Quando ti parlo, sto usando lo schermo 'say'. È responsabile di prendere il dialogo e presentarlo al giocatore."
...
translate italian screens_demo_1bdfb4bd:
    ...
    e "E quando l'istruzione menu mostra una scelta nel gioco, viene usato lo schermo 'choice'. Capito?" nointeract
...
translate italian screens_demo_31a20e24:
    ...
    e "L'input di testo usa lo schermo 'input', la modalità NVL usa lo schermo 'nvl', e così via."
...
translate italian screens_demo_5a5aa2d5:
    ...
    e "Più di uno schermo può essere visualizzato contemporaneamente. Ad esempio, i pulsanti in basso - Indietro, Cronologia, Salta, e così via - sono tutti visualizzati da uno schermo quick_menu che è mostrato sempre."
...
translate italian screens_demo_58d48fde:
    ...
    e "Ci sono molti schermi speciali, come 'main_menu', 'load', 'save', e 'preferences'. Piuttosto che elencarli tutti qui, ti {a=https://www.renpy.org/doc/html/screen_special.html}invio alla documentazione{/a}."
...
translate italian screens_demo_27476d11:
    ...
    e "In un progetto appena creato, tutti questi schermi si trovano in screens.rpy. Puoi modificare quel file per cambiarli."
...
translate italian screens_demo_a699b1cb:
    ...
    e "Non sei limitato nemmeno a questi schermi. In Ren'Py, puoi creare i tuoi schermi e usarli per l'interfaccia del tuo gioco."
...
translate italian screens_demo_a136e191:
    ...
    e "Ad esempio, in una visual novel simile a un RPG, uno schermo può visualizzare le statistiche del giocatore."

# game/tutorial_screens.rpy:234
translate italian screens_demo_1f50f3d3:

    # e "Which reminds me, I should probably heal you."
    e "Il che mi ricorda, probabilmente dovrei curarti."
...
translate italian screens_demo_8a54de7a:
    ...
    e "Schermi complessi possono essere la base di intere meccaniche di gioco. Uno schermo delle statistiche come questo può essere la base per dating sim e life-sim."
...
translate italian screens_demo_62c184f8:
    ...
    e "Mentre gli schermi potrebbero essere complessi, sono davvero solo il risultato di molte parti semplici che lavorano insieme per creare qualcosa di più grande di tutte loro."
...
translate italian screens_showing_1b51e9a4:
    ...
    e "Ecco un esempio di uno schermo molto semplice. L'istruzione screen è usata per dire a Ren'Py che questo è uno schermo, e il suo nome è simple_screen." id screens_showing_1b51e9a4
...
translate italian screens_showing_5a6bbad0:
    ...
    e "All'interno dell'istruzione screen, le righe introducono elementi visualizzabili come frame, vbox, text, e textbutton; o proprietà come action, xalign, e ypos."
...
translate italian screens_showing_ae40755c:
    ...
    e "Lavorerò dall'interno verso l'esterno per descrivere le istruzioni. Ma prima, mostrerò lo schermo così puoi vederlo in azione."
...
translate italian screens_showing_bc320819:
    ...
    e "L'istruzione text è usata per visualizzare il testo fornito."
...
translate italian screens_showing_64f23380:
    ...
    e "L'istruzione textbutton introduce un pulsante che può essere cliccato. Quando il pulsante viene cliccato, l'azione fornita viene eseguita."
...
translate italian screens_showing_e8f68c08:
    ...
    e "Entrambi sono all'interno di un vbox, che significa scatola verticale, istruzione - che posiziona il testo sopra il pulsante."
...
translate italian screens_showing_7e48fc22:
    ...
    e "E quello è all'interno di un frame che fornisce lo sfondo e i bordi. Il frame ha una proprietà at che prende una trasformazione che dà la sua posizione."
...
translate italian screens_showing_80425bf3:
    ...
    e "Ci sono tre istruzioni che vengono usate per visualizzare gli schermi."
...
translate italian screens_showing_7d2deb37:
    ...
    e "La prima è l'istruzione show screen, che visualizza uno schermo e permette a Ren'Py di continuare."

# game/tutorial_screens.rpy:293
translate italian screens_showing_7626dc8b:

    # e "The screen will stay shown until it is hidden."
    e "Lo schermo rimarrà visualizzato finché non viene nascosto."
...
translate italian screens_showing_c79038a4:
    ...
    e "Nascondere uno schermo si fa con l'istruzione hide screen."
...
translate italian screens_showing_8f78a97d:
    ...
    e "L'istruzione call screen ferma Ren'Py dall'eseguire lo script finché lo schermo non restituisce un valore, o salta lo script da qualche altra parte."
...
translate italian screens_showing_b52e420c:
    ...
    e "Dato che non possiamo visualizzare il dialogo allo stesso tempo, dovrai cliccare 'Okay' per continuare."
...
translate italian screens_showing_c5ca730f:
    ...
    e "Quando un'istruzione call screen finisce, lo schermo viene automaticamente nascosto."
...
translate italian screens_showing_a38d1702:
    ...
    e "Generalmente, usi show screen per mostrare overlay che sono sempre visibili, e call screen per mostrare schermi con cui il giocatore interagisce per un po'."
...
translate italian screens_parameters_0666043d:
    ...
    e "Ecco un esempio di uno schermo che prende tre parametri. Il parametro message è un messaggio da mostrare, mentre le azioni okay e cancel vengono eseguite quando viene scelto il pulsante appropriato."
...
translate italian screens_parameters_cf95b914:
    ...
    e "Mentre il parametro message deve sempre essere fornito, i parametri okay e cancel hanno valori predefiniti che vengono usati se non viene dato alcun argomento."
...
translate italian screens_parameters_4ce03111:
    ...
    e "Ogni parametro è una variabile che viene definita all'interno dello schermo. All'interno dello schermo, queste variabili hanno priorità su quelle usate nel resto di Ren'Py."
...
translate italian screens_parameters_106c2a04:
    ...
    e "Quando uno schermo viene mostrato, possono essere forniti argomenti per ciascuno dei parametri. Gli argomenti possono essere dati per posizione o per nome."
...
translate italian screens_parameters_12ac92d4:
    ...
    e "I parametri ci permettono di cambiare cosa mostra uno schermo, semplicemente ri-mostrandolo con argomenti diversi."
...
translate italian screens_parameters_d143a994:
    ...
    e "L'istruzione call screen può anche prendere argomenti, proprio come fa show screen."
...
translate italian screens_properties_423246a2:
    ...
    e "Ci sono alcune proprietà che possono essere applicate a uno schermo stesso."
...
translate italian screens_properties_4fde164e:
    ...
    e "Quando la proprietà modal è vera, non puoi interagire con le cose sotto lo schermo. Dovrai cliccare 'Chiudi Questo Schermo' prima di poter continuare."
...
translate italian screens_properties_550c0bea:
    ...
    e "Quando uno schermo ha la proprietà tag, viene trattato come la parte tag di un nome immagine. Qui, sto mostrando a_tag_screen."
...
translate italian screens_properties_4fcf8af8:
    ...
    e "Quando mostro b_tag_screen, sostituisce a_tag_screen."
...
translate italian screens_properties_7ed5a791:
    ...
    e "Questo è utile nei menu di gioco e principali, dove vuoi che lo schermo di caricamento sostituisca lo schermo delle preferenze. Per impostazione predefinita, tutti quegli schermi hanno il tag menu."
...
translate italian screens_properties_5d51bd1e:
    ...
    e "Per qualche ragione, tag prende un nome, e non un'espressione. È troppo tardi per cambiarlo."
...
translate italian screens_properties_6706e266:
    ...
    e "La proprietà zorder controlla l'ordine in cui gli schermi si sovrappongono tra loro. Più grande è il numero zorder, più vicino è lo schermo al giocatore."
...
translate italian screens_properties_f7a2c73d:
    ...
    e "Per impostazione predefinita, uno schermo ha un zorder di 0. Quando due schermi hanno lo stesso numero zorder, lo schermo che viene mostrato per secondo è più vicino al giocatore."
...
translate italian screens_properties_78433eb8:
    ...
    e "La proprietà variant seleziona uno schermo basato sulle proprietà del dispositivo su cui sta funzionando."
...
translate italian screens_properties_e6db6d02:
    ...
    e "In questo esempio, il primo schermo sarà usato per dispositivi piccoli come telefoni, e l'altro schermo sarà usato per tablet e computer."
...
translate italian screens_properties_d21b5500:
    ...
    e "Infine, la proprietà style_prefix specifica un prefisso che viene applicato agli stili nello schermo."
...
translate italian screens_properties_560ca08a:
    ...
    e "Quando viene dato il prefisso 'red', il frame ottiene lo stile 'red_frame', e il testo ottiene lo stile 'red_text'."
...
translate italian screens_properties_c7ad3a8e:
    ...
    e "Questo può far risparmiare molto tempo di digitazione quando si stilizzano schermi con molti elementi visualizzabili al loro interno."
...
translate italian screens_control_4a1d8d7c:
    ...
    e "Il linguaggio degli schermi ha alcune istruzioni che fanno cose diverse dal mostrare elementi visualizzabili. Se non hai ancora visto la sezione su {a=jump:warp_screen_displayables}Elementi Visualizzabili degli Schermi{/a}, potresti volerla controllare, poi tornare qui."
...
translate italian screens_control_0e939050:
    ...
    e "L'istruzione python funziona più o meno allo stesso modo che fa nello script. Una singola riga di Python viene introdotta con un segno del dollaro. Questa riga viene eseguita ogni volta che lo schermo si aggiorna."
...
translate italian screens_control_6334650a:
    ...
    e "Allo stesso modo, l'istruzione python introduce un blocco indentato di istruzioni python. Ma c'è una grande differenza tra Python negli schermi e Python negli script."
...
translate italian screens_control_ba8f5f13:
    ...
    e "Il Python che usi negli schermi non può avere effetti collaterali. Questo significa che non può fare cose come cambiare il valore di una variabile."
...
translate italian screens_control_f75fa254:
    ...
    e "La ragione di questo è che Ren'Py eseguirà uno schermo, e il Python al suo interno, durante la previsione dello schermo."
...
translate italian screens_control_40c12afa:
    ...
    e "L'istruzione default ti permette di impostare il valore di una variabile dello schermo la prima volta che lo schermo viene eseguito. Questo valore può essere cambiato con le azioni SetScreenVariable e ToggleScreenVariable."
...
translate italian screens_control_39e0f7e6:
    ...
    e "L'istruzione default differisce dall'istruzione Python in quanto viene eseguita solo una volta. Python viene eseguito ogni volta che lo schermo si aggiorna, e quindi la variabile non cambierebbe mai valore."
...
translate italian screens_control_87a75fe7:
    ...
    e "L'istruzione if funziona come fa nello script, eseguendo un blocco se la condizione è vera e un altro se la condizione è falsa."
...
translate italian screens_control_6a8c07f6:
    ...
    e "L'istruzione for prende una lista di valori, e li itera attraverso di essi, eseguendo il blocco all'interno del ciclo for con la variabile legata a ogni elemento della lista."
...
translate italian screens_control_f7b755fa:
    ...
    e "Le istruzioni on e key probabilmente hanno senso solo al livello superiore dello schermo."
...
translate italian screens_control_328b0676:
    ...
    e "L'istruzione on fa eseguire allo schermo un'azione quando si verifica un evento. L'evento 'show' accade quando lo schermo viene mostrato per la prima volta, e l'evento 'hide' accade quando viene nascosto."
...
translate italian screens_control_6768768b:
    ...
    e "L'evento key esegue un evento quando viene premuto un tasto."
...
translate italian screen_use_c6a20a16:
    ...
    e "L'istruzione use del linguaggio degli schermi ti permette di includere uno schermo all'interno di un altro. Questo può essere utile per prevenire duplicazioni all'interno degli schermi."
...
translate italian screen_use_95a34d3a:
    ...
    e "Prendi ad esempio questo schermo, che mostra due voci di statistiche. C'è già molta duplicazione lì, e se avessimo più statistiche, ce ne sarebbe di più."
...
translate italian screen_use_e2c673d9:
    ...
    e "Qui, abbiamo spostato le istruzioni che mostrano il testo e la barra in un secondo schermo, e l'istruzione use include quello schermo nel primo."
...
translate italian screen_use_2efdd2ff:
    ...
    e "Il nome e la quantità della statistica vengono passati come argomenti allo schermo, proprio come viene fatto nell'istruzione call screen."
...
translate italian screen_use_f8d1bf9d:
    ...
    e "Facendolo in questo modo, controlliamo la quantità di duplicazione, e possiamo cambiare la statistica in un posto."
...
translate italian screen_use_4e22c25e:
    ...
    e "L'istruzione transclude va un passo oltre, permettendo all'istruzione use di prendere un blocco di istruzioni del linguaggio degli schermi."
...
translate italian screen_use_c83b97e3:
    ...
    e "Quando lo schermo incluso raggiunge l'istruzione transclude, viene sostituito con il blocco dall'istruzione use."
...
translate italian screen_use_1ad1f358:
    ...
    e "Lo schermo boilerplate è incluso nel primo, e il testo dal primo schermo viene trascluso nello schermo boilerplate."
...
translate italian screen_use_f74fab6e:
    ...
    e "Use e transclude sono complessi, ma molto potenti. Se ci pensi, 'use boilerplate' è solo un passo rimosso dallo scrivere la tua propria istruzione del Linguaggio degli Schermi."
...
translate italian strings:
 ...
 translate italian strings:
    ...
    new "Cosa possono fare gli schermi."

    # game/tutorial_screens.rpy:171
    old "How to show screens."
    new "Come mostrare gli schermi."

    # game/tutorial_screens.rpy:171
    old "Passing parameters to screens."
    new "Passare parametri agli schermi."

    # game/tutorial_screens.rpy:171
    old "Screen properties."
    new "Proprietà degli schermi."

    # game/tutorial_screens.rpy:171
    old "Special screen statements."
    new "Istruzioni speciali per gli schermi."

    # game/tutorial_screens.rpy:171
    old "Using other screens."
    new "Usare altri schermi."
    ...
    new "Clicca qualsiasi pulsante per continuare."

    # game/tutorial_screens.rpy:377
    old "Close This Screen"
    new "Chiudi Questo Schermo"
    ...
    new "Lo schermo è stato appena mostrato."

    # game/tutorial_screens.rpy:585
    old "You pressed the 'a' key."
    new "Hai premuto il tasto 'a'."
    ...
    new "Non c'è più molto da vedere."
