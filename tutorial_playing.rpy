...
translate italian tutorial_playing_2985ab86:
    ...
    e "Come qualcuno che ha giocato a più di qualche visual novel, ci sono molte funzionalità che mi aspetto che tutti i giochi abbiano."
...
translate italian tutorial_playing_ca4769bb:
    ...
    e "Funzionalità come salvare, caricare, cambiare le preferenze, e così via."
...
translate italian tutorial_playing_f30f1979:
    ...
    e "Una delle cose belle di Ren'Py è che il motore fornisce molte di queste funzionalità per te. Puoi spendere il tuo tempo a creare il tuo gioco, e lasciarci fornire queste cose."
...
translate italian tutorial_playing_afa743e7:
    ...
    e "Mentre sei nel gioco, puoi accedere al menu di gioco cliccando con il tasto destro o premendo il tasto escape."
...
translate italian tutorial_playing_1a6c8296:
    ...
    e "Puoi anche accedere al menu di gioco attraverso alcuni dei pulsanti del menu rapido in fondo a questo schermo."
...
translate italian tutorial_playing_8360224a:
    ...
    e "Quando entri per la prima volta nel menu di gioco, vedrai lo schermo di salvataggio. Cliccando su uno slot numerato salverai il gioco."
...
translate italian tutorial_playing_edea14ff:
    ...
    e "A differenza di altri motori, Ren'Py non limita il numero di slot di salvataggio che puoi usare. Puoi continuare a premere avanti fino a raggiungere la pagina che vuoi."
...
translate italian tutorial_playing_900ce396:
    ...
    e "Cliccando sul titolo della pagina puoi iniziare a digitare per cambiare il nome della pagina."
...
translate italian tutorial_playing_fea05c6b:
    ...
    e "Lo schermo di caricamento sembra abbastanza simile allo schermo di salvataggio e ti permette di caricare un gioco da uno slot di salvataggio."
...
translate italian tutorial_playing_8e7e83a8:
    ...
    e "Ti permette anche di caricare uno dei salvataggi automatici che Ren'Py fa per te."

# game/tutorial_playing.rpy:38
translate italian tutorial_playing_4b21f071:

    # e "The game menu also has the preferences screen."
    e "Il menu di gioco ha anche lo schermo delle preferenze."
...
translate italian tutorial_playing_eaac8ba9:
    ...
    e "Questo schermo ti permette di decidere come Ren'Py visualizza, scegliere cosa Ren'Py salta, controllare la velocità del testo e la velocità di avanzamento automatico, e regolare i volumi di suoni, musica e voci."
...
translate italian tutorial_playing_b1562a34:
    ...
    e "Il menu di gioco ti permette anche di terminare il gioco e tornare al menu principale, o uscire completamente da Ren'Py."
...
translate italian tutorial_playing_790f9dc7:
    ...
    e "Mentre i menu di gioco predefiniti sembrano un po' generici, con un po' di lavoro possono essere personalizzati o anche completamente sostituiti, permettendoti di creare menu unici quanto il tuo gioco."
...
translate italian tutorial_playing_bc29822e:
    ...
    e "Mentre sei dentro il gioco, ci sono alcune altre cose che puoi fare."
...
translate italian tutorial_playing_dc0f9cf7:
    ...
    e "Quando mi piace una visual novel, voglio vedere tutti i finali. La funzione di salto di Ren'Py mi permette di farlo facilmente, saltando il testo che ho già visto."
...
translate italian tutorial_playing_93f7b8f9:
    ...
    e "Posso saltare alcune righe tenendo premuto Control, oppure posso attivare la modalità salto cliccando il pulsante salta in fondo allo schermo."
...
translate italian tutorial_playing_d3553fbe:
    ...
    e "Per impostazione predefinita, saltiamo solo il testo letto, quindi questo non farà nulla la prima volta che giochi."
...
translate italian tutorial_playing_fc0cac03:
    ...
    e "Cliccando il pulsante auto si attiva la modalità avanzamento automatico, che fa avanzare il gioco senza che tu clicchi."
...
translate italian tutorial_playing_14e1c854:
    ...
    e "I pulsanti Salvataggio Rapido e Caricamento Rapido forniscono un modo con un solo clic per fare un salvataggio e un modo veloce per caricare di nuovo quel salvataggio."
...
translate italian tutorial_playing_5d6e4c0f:
    ...
    e "Premendo il tasto 's' si salva uno screenshot sul disco, così posso caricare immagini del gioco su siti web come {a=https://www.renpy.org}renpy.org{/a}."
...
translate italian tutorial_playing_73f3cfec:
    ...
    e "Il pulsante cronologia visualizza una cronologia del testo letto - ma puoi anche usare il rollback, che di solito è meglio."
...
translate italian tutorial_playing_f065a34c:
    ...
    e "Vorresti sentire parlare del rollback?" nointeract
...
translate italian tutorial_rollback_a520091b:
    ...
    e "Puoi invocare un rollback cliccando il pulsante 'Indietro', scorrendo la rotella del mouse verso l'alto, o premendo il tasto pagina su. Questo ti riporterà allo schermo precedente."
...
translate italian tutorial_rollback_041be71b:
    ...
    e "Mentre sei a uno schermo precedente, puoi andare avanti scorrendo la rotella del mouse verso il basso, o premendo il tasto pagina giù."
...
translate italian tutorial_rollback_4b903465:
    ...
    e "Andare avanti attraverso un menu farà la stessa scelta che hai fatto l'ultima volta. Ma non devi farlo - il sistema di rollback di Ren'Py ti permette di fare una scelta diversa."
...
translate italian tutorial_rollback_a4633f53:
    ...
    e "Puoi provarlo tornando indietro attraverso l'ultimo menu e dicendo 'No'."
...
translate italian tutorial_rollback_5b73f822:
    ...
    e "Clicca indietro alcune volte, premi pagina su, o scorri verso l'alto la rotella del mouse."
...
translate italian tutorial_rollback_done_6564cd32:
    ...
    e "Permettendo a Ren'Py di occuparsi di questioni fuori dal gioco come caricare e salvare, puoi concentrarti sulla creazione del tuo gioco, dando comunque ai giocatori l'esperienza che si aspettano quando giocano alle visual novel."
